...
const projects = [
  {
    id: "zephron",
    name: "ZEPHRON",
    tagline: "Autonomous NetSec Platform",
    ...
    stats: [
      { label: "Skills", value: "120+" },
      { label: "MCP Servers", value: "52" },
      { label: "Zabbix Tools", value: "40+" },
      { label: "Dev Weeks", value: "22" },
    ],
    tech: ["Python", "Docker Compose", "Zabbix", "LangGraph", "FastMCP", "ClickHouse"],
  ...
  },
  {
    id: "0xpwn",
    name: "0xPWN",
    tagline: "Autonomous AI Pentesting Agent",
    ...
    stats: [
      ...
      { label: "LLM Providers", value: "100+" },
      { label: "Vuln Classes", value: "40+" },
      { label: "Gap Items", value: "35+" },
    ],
    tech: ["Python", "LiteLLM", "Docker", "Kali Linux", "MCP Protocol", "Apache 2.0"],
    status: "PLANNING",
    phase: 30,
    icon: "💀",
  },
  {
    id: "policyfoundry",
    name: "POLICYFOUNDRY",
    tagline: "AI Firewall Policy Manager",
    ...
    stats: [
      { label: "Vendor Adapters", value: "6" },
      { label: "Autonomy Phases", value: "4" },
      { label: "License", value: "BSL 1.1" },
      { label: "Storage", value: "2 DBs" },
    ],
    tech: ["Python", "LangGraph", "AWS Bedrock", "ClickHouse", "DuckDB", "TypeScript"],
    status: "ARCHITECTURE",
    phase: 40,
    icon: "🔥",
  },
  {
    id: "zscaler-mcp",
    name: "ZSCALER MCP",
    tagline: "Complete Zscaler MCP Server",
    ...
    stats: [
      { label: "Total Tools", value: "~188" },
      { label: "Products", value: "8" },
      { label: "ZIA Tools", value: "~60" },
      { label: "ZPA Tools", value: "~60" },
    ],
    tech: ["Python", "FastMCP", "Railway", "Docker", "Zscaler SDK", "SSE Transport"],
    status: "IN DEVELOPMENT",
    phase: 55,
    icon: "☁️",
  },
  {
    id: "network-mcps",
    name: "NETWORK MCPs",
    tagline: "Multi-Vendor MCP Servers",
    ...
    stats: [
      ...
      { label: "Prisma Gap", value: "100%" },
      { label: "Pattern", value: "FastMCP" },
    ],
    tech: ["Python", "FastMCP", "Prisma SDK", "Meraki SDK", "Mist SDK", "Docker"],
    status: "RESEARCH",
    phase: 25,
    icon: "🌐",
  },
  {
    id: "netsec-skills",
    name: "NETSEC SKILLS",
    tagline: "AI Agent Skills Library",
    ...
    stats: [
      ...
      { label: "Safety Tiers", value: "3" },
    ],
    tech: ["TypeScript", "Python", "pnpm", "Changesets", "SKILL.md", "MCP"],
    status: "ARCHITECTURE",
    phase: 35,
    icon: "🧠",
  },
  {
    id: "repoforge",
    name: "REPOFORGE",
    tagline: "Guided Repo Bootstrapper",
    ...
    stats: [
      { label: "Target ARR", value: "$16.8M" },
      { label: "Free Tier", value: "$0" },
      { label: "Pro Tier", value: "$39/mo" },
      { label: "Templates", value: "∞" },
    ],
    tech: ["Python", "FastAPI", "Copier", "GitHub Apps", "React", "PostgreSQL"],
    status: "IN DEVELOPMENT",
    phase: 45,
    icon: "⚡",
  },
  {
    id: "strat-trading",
    name: "STRAT TRADING",
    tagline: "AI-Powered Trading System",
    category: "FINTECH",
    accent: "#00ff87",
    ...
    stats: [
      { label: "Architecture", value: "8 Layers" },
      { label: "Monthly Cost", value: "$41-120" },
      { label: "Data Source", value: "Polygon" },
      { label: "Broker", value: "Alpaca" },
    ],
    tech: ["Python", "Polygon.io", "Alpaca", "Lumibot", "TimescaleDB", "GPT-4"],
    status: "ARCHITECTURE",
    phase: 30,
    icon: "📈",
  },
  ...
  },
  {
    ...
    stats: [
      { label: "Arch Layers", value: "6" },
      { label: "AI Engine", value: "Due Diligence" },
      { label: "Matching", value: "ML-Powered" },
      { label: "Module", value: "Acqui-Hire" },
    ],
    tech: ["React", "Node.js", "Python", "PostgreSQL", "Redis", "ML Pipeline"],
    status: "PLANNING",
    phase: 20,
    icon: "🏪",
  },
  {
    id: "echelon",
    name: "ECHELON",
    tagline: "AI Real Estate Operations",
    category: "PROPTECH",
    accent: "#ff6b35",
    ...
    stats: [
      ...
      { label: "Industry Avg", value: "15+ hrs" },
      { label: "Lead Agent", value: "Scout" },
      { label: "Pricing", value: "Flat/mo" },
    ],
    tech: ["Python", "LangChain", "MLS API", "CRM APIs", "Twilio", "React"],
    status: "PLANNING",
    phase: 25,
    icon: "🏠",
  },
  ...
  },
  {
    ...
    stats: [
      { label: "Problem Areas", value: "10" },
      { label: "Total VC", value: "$6.3B+" },
      { label: "Top Area", value: "SOC Auto" },
      { label: "Coverage", value: "Full Stack" },
    ],
    tech: ["Market Analysis", "VC Data", "Competitive Intel", "Radar Charts", "Bubble Maps"],
    status: "COMPLETE",
    phase: 100,
    icon: "🔬",
  },
...
const categoryColors = {
  ...
  "OFFENSIVE SECURITY": "#00ff87",
  "NETWORK SECURITY": "#b44dff",
  "CLOUD SECURITY": "#ff6b35",
  "NETWORK AUTOMATION": "#ffdd00",
  "AI INFRASTRUCTURE": "#00e5ff",
  "DEVELOPER TOOLS": "#ff3e3e",
  FINTECH: "#00ff87",
  MARKETPLACE: "#b44dff",
  PROPTECH: "#ff6b35",
  RESEARCH: "#ffdd00",
...
const CyberGrid = () => (
  <div style={{
    ...
    <div style={{
      ...
      background: "radial-gradient(ellipse at 30% 20%, rgba(0,229,255,0.04) 0%, transparent 60%), radial-gradient(ellipse at 70% 80%, rgba(180,77,255,0.04) 0%, transparent 60%)",
    }} />
  </div>
);
...
export default function UnifiedPortfolioDashboard() {
  ...
  const totalTools = "400+";
  const totalSkills = "120+";
  const domains = "7";
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "50px" }}>
          ...
          <h1 style={{
            ...
            background: glitchText
              ? "linear-gradient(90deg, #ff3e3e, #00ff87, #b44dff)"
              : "linear-gradient(135deg, #00e5ff 0%, #b44dff 50%, #00ff87 100%)",
            ...
            <div style={{
              ...
              {searchTerm && (
                <span
                  ...
                  style={{ color: "rgba(255,255,255,0.3)", cursor: "pointer", fontSize: "0.8rem" }}
                >
                  ✕
                </span>
              )}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <NeonText color="#b44dff" size="0.65rem" style={{ letterSpacing: "3px" }}>
              TECHNOLOGY RADAR
            </NeonText>
          </div>
